var drawTable = function(finalData) {
	...
	var bar = svg.selectAll(".bar")
					.data(finalData, function(d) {return d.id;});
	...
	newBar.append("a")
		.attr("dy", ".35em")
		.attr("xlink:href", function(d) {return "#/contestant/view/" + d.id;})
		.append("text")
			.attr("class", "link")
			.attr("x", 770)
			.attr("y", 15)
...
pjjApp.controller('ListContestantController', ['$scope', '$http', 'urlProvider',
	...
	$http({method: 'GET', url: urlProvider.getContestantList()}).
